                                   ...
                                   <p class="border-2 border-dotted "></p>
                                    <div class="flex justify-between">
                                       ...
                                       <p class="flex justify-center items-center gap-2"><i class="fa-regular fa-message"></i>${items.comment_count}</p>
                                        ...
                                        <button onClick="handledetails('${items.title?items}','${items.view_count}')"><i class="fa-solid fa-envelope text-white flex justify-center items-center ml-3 mt-3"></i> </button>
