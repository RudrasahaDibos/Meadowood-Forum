const loadforum = async() =>{
  ...
  function getValueElementById(id){
   ...
   const handleSearch = async() =>{
     ...
     const res = await fetch(`https://openapi.programming-hero.com/api/retro-forum/posts?category=${https://openapi.programming-hero.com/api/retro-forum/posts?category=categoryName}`)
   }
