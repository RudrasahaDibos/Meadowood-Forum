                                   ...
                                   <p class="border-2 border-dotted "></p>
                                    <div class="flex justify-between">
                                       ...
                                       <p class="flex justify-center items-center gap-2"><i class="fa-regular fa-message"></i>${items.comment_count}</p>
                                        <p class="flex justify-center items-center gap-2"><i class="fa-regular fa-eye"></i>${items}</p>
                                        <p class="flex justify-center items-center gap-2"><i class="fa-regular fa-compass"></i>${items.view_count
                                        }</p>
                                        </div>
                                        <div class=" bg-green-600 h-10 w-10 rounded-full">
                                        <button><i class="fa-solid fa-envelope text-white flex justify-center items-center ml-3 mt-3"></i> </button>
