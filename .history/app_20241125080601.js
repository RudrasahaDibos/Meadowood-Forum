const loadforum = async() =>{
    ...
    data.posts.forEach(items => {
         ...
         <div class="avatar indicator">
                                        ...
                                        <span class="indicator-item ml-16 mt-4  indicator-start badge badge-secondary">${items.isActive? `<p  class="indicator-item ml-16 mt-4  indicator-start badge badge-secondary></p>`:"gelo"}</span>
